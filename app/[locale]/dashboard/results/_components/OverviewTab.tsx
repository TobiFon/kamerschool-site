...
const OverviewTab = ({
  ...
  console.log("Class Statistics:", classStatistics.subject_statistics);
              ...
              <div key={student.id} className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-gray-500 flex items-center mt-1">
                    <Badge className={`mr-2 ${getAverageBg(student.average)}`}>
                      {parseFloat(student.average).toFixed(2)}/20
                    </Badge>
        ...
        <Card className="shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="p-6 space-y-4">
            <div className="space-y-2">
              ...
              <Progress
                value={
                  (classStatistics.excellent_count /
                    classStatistics.total_students) *
                  100
                }
            ...
            <div className="space-y-2">
              ...
              <Progress
                value={
                  (classStatistics.very_good_count /
                    classStatistics.total_students) *
                  100
                }
                className="h-2 bg-gray-100"
            ...
            <div className="space-y-2">
              ...
              <Progress
                value={
                  (classStatistics.needs_improvement_count /
                    classStatistics.total_students) *
                  100
                }
                className="h-2 bg-gray-100"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-xs mt-1">
                      ...
                      <Badge variant="outline" className="text-xs">
                        ...
                        {subject.total_count || classStatistics.total_students}{" "}
                        {t("passed")}
                      </Badge>
                    </div>
                  </div>
